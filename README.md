## This is an attempt to partially implement the security infrastructure of QubesOS in Nix, without the restrictions of gpu access.
## It assumes that your physical infrastructure is secure and the only threat is the internet.
